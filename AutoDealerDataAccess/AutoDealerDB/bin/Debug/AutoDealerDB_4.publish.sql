...
BEGIN TRY
	INSERT INTO [dbo].[Ads]
	([Title], [DatePosted], [ModelName], [Description], [Price], [ClientName] ,[Address], [City], [ZIP], 
	 [Country], [Phone], [BrandId], [CarBodyTypeId], [CarConditionId], [ColorId], [FuelId], [ProductionYearId])
	VALUES
	(@Title, @DatePosted, @ModelName, @Description, @Price, @ClientName, @Address, @City, @ZIP, 
	 @Country, @Phone, @BrandId, @CarBodyTypeId, @CarConditionId, @ColorId, @FuelId, @ProductionYearId);
...
AS
	SET NOCOUNT ON;
BEGIN TRY
	SELECT [Id], [Title], [DatePosted], [ModelName], [Description], [Price], [ClientName], [Address], [City], [ZIP], 
		   [Country], [Phone], [BrandId], [CarBodyTypeId], [CarConditionId], [ColorId], [FuelId], [ProductionYearId]
	FROM [dbo].[Ads]
	WHERE [Id] = @Id;
	RETURN 0;
