...
GO
PRINT N'Creating [dbo].[CarBasics]...';


GO
CREATE TABLE [dbo].[CarBasics] (
    [Id]            INT           IDENTITY (1, 1) NOT NULL,
...
BEGIN TRY
	INSERT INTO [dbo].[Ads]
	([Title], [DatePosted], [Description], [Price], [CarBasicId], [ClientId], [BrandId], 
	 [CarBodyTypeId], [CarConditionId], [ColorId], [FuelId], [ProductionYearId])
	VALUES
	(@Title, @DatePosted, @Description, @Price, @CarBasicId, @ClientId, @BrandId, 
	 @CarBodyTypeId, @CarConditionId, @ColorId, @FuelId, @ProductionYearId);
...
AS
	SET NOCOUNT ON;
BEGIN TRY
	SELECT [Id], [Title], [DatePosted], [Description], [Price], [CarBasicId], [ClientId], [BrandId], 
		   [CarBodyTypeId], [CarConditionId], [ColorId], [FuelId], [ProductionYearId]
	FROM [dbo].[Ads]
	WHERE [Id] = @Id;
	RETURN 0;
...
END CATCH
GO
PRINT N'Creating [dbo].[spBrands_GetBrands]...';
...
END CATCH
GO
PRINT N'Creating [dbo].[spCarBasics_GetCarBasics]...';


GO
CREATE PROCEDURE [dbo].[spCarBasics_GetCarBasics]
AS
	SET NOCOUNT ON;
BEGIN TRY
	SELECT [Id], [ModelName], [Kilometers], [CubicCapacity], [HorsePower], [Kilowatts]
	FROM [dbo].[CarBasics];
	RETURN 0;
END TRY
BEGIN CATCH
...
END CATCH
GO
PRINT N'Creating [dbo].[spCarBodyTypes_GetBodyTypes]...';
...
END CATCH
GO
PRINT N'Creating [dbo].[spCarConditions_GetCarConditions]...';
...
END CATCH
GO
PRINT N'Creating [dbo].[spColors_GetColors]...';
...
END CATCH
GO
PRINT N'Creating [dbo].[spFuels_GetFuels]...';
...
END CATCH
GO
PRINT N'Creating [dbo].[spProductionYears_CreateYear]...';


GO
CREATE PROCEDURE [dbo].[spProductionYears_CreateYear]
	@YearName NVARCHAR(4),
	@Id INT OUTPUT
AS
	SET NOCOUNT ON;
...
END CATCH
GO
PRINT N'Creating [dbo].[spProductionYears_GetYears]...';
